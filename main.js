...
class Game {
    ...
    startStory() {
        ...
        this.storyMessages = [
            ...
            "バーテンダー<br>「迷宮の奥底から噴き出す瘴気が、街の家畜や子供たちを病ませ始めている。誰かが止めなきゃあならねぇ......。」",
            `${this.party[0].name}<br>「......ふん、またあの『渦』か。前に行った連中は誰一人戻っちゃいないんだろ？」`,
            `${this.party[1].name}<br>「だからこそ行く価値があるのさ。誰も手をつけていない財宝が、底には眠っているはずだよ。」`,
            `${this.party[2].name}<br>「......財宝はどうでもいい。我々の腕が、その『渦』とやらにどこまで通じるか......。試してみたいとは思わないか？」`,
            `${this.party[3].name}<br>「決まりだな！飲んでる暇もねぇ。この『渦』、俺たちが飲み込んでやろうぜ！」`,
